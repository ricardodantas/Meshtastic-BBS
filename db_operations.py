...
def delete_mail(unique_id, recipient_id, bbs_nodes, interface):
    ...
    try:
        ...
        logging.info("Attempting to delete mail with unique_id: %s by %s", unique_id, recipient_id)
        ...
        logging.info("Mail with unique_id: %s deleted and sync message sent.", unique_id)
